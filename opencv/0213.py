...
# 클래스 : 데이터와 기능을 함께 묶는 방법을 제공하는 것
# 새 클래스를 만드는 것은 객체의 새 형을 만들어서 형의 새 인스턴스(instance)를 만들 수 있도록합니다
#
class Video:
