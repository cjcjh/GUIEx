...
class Calculator(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.backspaceButton = self.createButton("B.s", self.backspaceClicked)
        ...
        mainLayout.addWidget(self.clearButton, 1, 0)

        for i in range(1, Calculator.NumDigitButtons):
            row = ((9 - i) / 3) + 2
            column = ((i - 1) % 3)
            mainLayout.addWidget(self.digitButtons[i], row, column, 1, 1)

        mainLayout.addWidget(self.digitButtons[0], 5, 0, 1, 2)
        mainLayout.addWidget(self.pointButton, 5, 2)

        mainLayout.addWidget(self.divisionButton, 5, 4)
        ...
        mainLayout.addWidget(self.equalButton, 1, 2, 1, 3)
